...
La figura seguente fornisce un esempio di quali potrebbero essere le preferenze di un consumatore quando $X$ è un generico bene di consumo (cibo, abbigliamento, trasporto, ecc.) e $Y$ l'appartamento dove vivere.
...
Un tipo di funzioni di utilità spesso utilizzate dagli economisti è quello <i>Cobb-Douglas</i> (dal nome dei due economisti che utilizzarono tali funzioni nei loro studi). Esse hanno la forma
