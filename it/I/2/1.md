...
La figura seguente fornisce un esempio di quali potrebbero essere le preferenze di un consumatore quando $X$ è un generico bene di consumo (cibo, abbigliamento, trasporto, ecc.) e $Y$ la dimensione dell'appartamento dove vivere.
